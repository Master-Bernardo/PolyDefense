...
public class TPCamComplex : MonoBehaviour 
{
    ...
    /*public float zoom;                                                 //multiplies the offset vector
    public float zoomSpeed;
    public float fpsTreshold;                                          //if our zoom is smaller than this we change to first Person
    ...
    public void RotateCam(float horizontalAngle, float verticalAngle, Quaternion rotation, Quaternion rotateRot)
    {
        ...
        Quaternion camYRotation = rotateRot;
        //Quaternion aimRotation = Quaternion.Euler(-angleV, angleH, 0);
        Quaternion aimRotation = rotation;
        //cam.rotation = rotation;
        cam.forward = player.position - transform.position;
        Debug.Log("cameraRot: " + rotation.eulerAngles);
    ...
    {
        targetCamOffset = targetCamOffset.normalized * zoom;
    }
